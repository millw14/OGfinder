...
export function DonationAddress() {
  ...
  return (
    <button
      type="button"
      onClick={copy}
      className="group inline-flex min-h-[44px] items-center gap-2 rounded-full border bg-surface-1 px-3 py-1.5 text-micro text-fg-3 transition-colors hover:border-line-str hover:bg-surface-2 hover:text-fg-2 sm:min-h-[36px]"
    ...
    >
      ...
      <span className={`text-micro${copyFailed ? " text-risk" : ""}`}>
